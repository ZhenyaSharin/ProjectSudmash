		...
		<div class="container-fluid foot">
			<div class="row-fluid">
				...
				<div class="offset2 span4 footext">
					<h3>КАРЬЕРА</h3>
						<p class="vacs"><i class="icon-user icon-white"></i><a href="/vacancy/1" style="color:white"> Технический специалист Autodesk Inventor, TDMS и IPS</a></p>
						<p class="vacs"><i class="icon-user icon-white"></i><a href="/vacancy/2" style="color:white"> Программист («1С», С++, Delfi и пр.)</a></p>
						<p class="vacs"><i class="icon-user icon-white"></i><a href="/vacancy/3" style="color:white"> Инженер - механик</a></p>
						<p class="vacs"><i class="icon-user icon-white"></i><a href="/vacancy/4" style="color:white"> Инженер - программист встраиваемой микропроцессорной техники</a></p>
						<p class="vacs"><i class="icon-user icon-white"></i><a href="/vacancy/5" style="color:white"> Инженер - электрик со специализацией в области силовой автоматики</a></p>
						<p class="vacs"><i class="icon-user icon-white"></i><a href="/vacancy/6" style="color:white"> Инженер по автоматизации гидравлических и/или энергетических установок</a></p>
						<p class="vacs"><i class="icon-user icon-white"></i><a href="/vacancy/7" style="color:white"> Инженер - конструктор радиоэлектронной аппаратуры</a></p>
				</div>
			</div>
			<div class="row-fluid">
